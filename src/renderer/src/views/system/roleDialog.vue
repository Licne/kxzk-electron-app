<template>
    <el-dialog v-model="dialogVisible" title="新增角色" width="600" @close="close">
        <template #default>
            <el-form :model="roleForm">
                ...
                <el-form-item label="状态">
                    <el-radio-group v-model="roleForm.enable">
                        <el-radio v-for="item in dicts.system_global_status" :key="item.id"
                            :label="roleForm.enabled == item.v ? roleForm.enable : item.v">{{ item.k }}</el-radio>
                    </el-radio-group>
                </el-form-item>
                ...
                <el-form-item label="菜单权限">
                    <div class="menu-item">
                        ...
                        <!-- 菜单权限树 -->
                        <el-tree ref="menuTreeRef" :data="permission.treeList" :props="permission.treeProps"
                            :check-strictly="!permission.linkage" :default-expand-all="permission.openAll" show-checkbox
                            node-key="id" class="tree">
                        </el-tree>
                    </div>
                </el-form-item>
                ...
                <el-form-item label="备注">
                    <el-input v-model="roleForm.descript" placeholder="请输入备注" type="textarea" :maxlength="200"
